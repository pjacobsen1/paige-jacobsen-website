...
import CardFlipSemadoc from '@/components/kokonutui/card-flip-semadoc';
import CardFlipRabble from '@/components/kokonutui/card-flip-rabble';
    ...
    <div>
        ...
        <main className="bg-[#fff0db] min-h-screen flex flex-col items-center p-12">
            ...
            <div className="flex items-center justify-center w-full mt-20 mb-10">
                <p className={fredericka.className + " text-6xl text-[#68875B] font-bold"}>
                    Projects
                </p>
            </div>
            ...
            <div className='w-full grid grid-cols-3 pl-40 pr-40 mt-20 gap-20'>
               ...
               <div className="flex items-center justify-center"><CardFlipLZW /></div>
            </div>

            {/* contact */}
            <section className="w-full bg-[#fff0db] flex flex-col items-center justify-center mt-14">
                <div className="flex flex-col justify-center h-full items-center -mb-3">
